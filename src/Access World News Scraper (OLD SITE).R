...
var_url <- 'https://infoweb.newsbank.com/resources/search/nb?page=1&p=AWNB&t=country%3AUSA%21USA/stp%3ANewspaper%21Newspaper&fld0=Lead&val0=%22PATRIOT%20Act%22&bln1=AND&fld1=YMD_date&val1=&sort=YMD_date%3AD'
